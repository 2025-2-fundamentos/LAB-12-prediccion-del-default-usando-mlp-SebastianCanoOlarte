...
def metricas(y_verdad, y_pred, tipo):
    return {
        "type": "metrics",
        "dataset": tipo,
...
def matriz_confusion(y_real, y_estimado, tipo):
...
metricas_train = metricas(y_train, train_pred, "train")
metricas_test = metricas(y_test, test_pred, "test")
matriz_train = matriz_confusion(y_train, train_pred, "train")
matriz_test = matriz_confusion(y_test, test_pred, "test")
